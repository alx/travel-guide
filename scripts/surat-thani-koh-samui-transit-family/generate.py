...
for i, stop in enumerate(STOPS):
    features.append({
        "type": "Feature",
        "id": f"surat-thani-koh-samui-transit-family-stop-{i + 1:02d}",
...
for leg in LEGS:
    ...
    features.append({
        "type": "Feature",
        "id": f"surat-thani-koh-samui-transit-family-leg-{leg['leg']:02d}",
...
out_path = REPO_ROOT / "static" / "surat-thani-koh-samui-transit-family" / "locations.geojson"
